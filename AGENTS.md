...
15. **Protocolo estricto de autorización (Planificación y confirmación requerida):** Antes de ejecutar cualquier tarea o hacer modificaciones en código, **siempre** debes: 1) Confirmar qué entendiste de la solicitud, 2) Explicar el plan detallado de cómo lo vas a resolver, y 3) Detenerte y esperar la autorización explícita del usuario para continuar. Por ningún motivo empieces a ejecutar sin esta confirmación.
